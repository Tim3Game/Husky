...
export default class extends Language {
    ...
    constructor(
        ...
        this.language = {
			...
			COMMAND_LOAD_DESCRIPTION: 'Carga una pieza de Klasa.',
			COMMAND_REBOOT: ' 🔄 **Reiniciando...** 🔄 ',
			COMMAND_REBOOT_DESCRIPTION: 'Reinicia el bot.',
			COMMAND_TRANSFER_DESCRIPTION: 'Transfiere una pieza de Klasa',
			COMMAND_PING: '¿Ping?',
			...
			COMANDO_INVITE: (invite: string) => [
				`**Link de invitación: [Click aquí](${invite})**`
			]
